...
class Chatbot:
    ...
    def bot_reply(self, user_text: str) -> str:
        ...
        low = user_text.lower()
        if any(w in low for w in ["help","problem","issue","complain","error","delay","late","Your service disappoints me",
        "I waited too long and support never replied","bad","terrible","sad","hate","poor","worse","disappointed","disappoints",
        ...
        if any(w in low for w in ["thanks","thank you","thx","Last experience was better",
        "Thanks for listening","good","great","happy","love","excellent","better","satisfied","awesome",
...
if __name__ == '__main__':
    ...
    while True:
        ...
        reply = bot.interact_once(user_msg)
        print("Bot:", reply, "\n")
